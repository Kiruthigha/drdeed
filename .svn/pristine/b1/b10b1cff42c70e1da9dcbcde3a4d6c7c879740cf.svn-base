...
;(function(factory) {
    ...
    Slick1 = (function() {
        ...
        function Slick1(element, settings) {
            ...
            _.defaults = {
                ...
                arrows: true,
                asNavFor: null,
                prevArrow: '<button class="slick1-prev" aria-label="Previous" type="button" style="z-index:90000;">Previous</button>',
    ...
    Slick1.prototype.addSlide = Slick1.prototype.slickAdd = function(markup, index, addBefore) {
    ...
    Slick1.prototype.setOption =
    Slick1.prototype.slickSetOption = function() {
    ...
    Slick1.prototype.updateArrows = function() {
        ...
        if ( _.options.arrows === true &&
            ...
            _.$prevArrow.removeClass('slick1-disabled').attr('aria-disabled', 'false');
            _.$nextArrow.removeClass('slick1-disabled').attr('aria-disabled', 'false');

            if (_.currentSlide === 0) {

                _.$prevArrow.addClass('slick1-disabled').attr('aria-disabled', 'true');
                _.$nextArrow.removeClass('slick1-disabled').attr('aria-disabled', 'false');

            } else if (_.currentSlide >= _.slideCount - _.options.slidesToShow && _.options.centerMode === false) {

                _.$nextArrow.addClass('slick1-disabled').attr('aria-disabled', 'true');
                _.$prevArrow.removeClass('slick1-disabled').attr('aria-disabled', 'false');
